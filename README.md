...
```
cd existing_repo
git remote add origin https://gitlab.com/durydevelop/nodejs/dremailer.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/durydevelop/nodejs/dremailer/-/settings/integrations)
